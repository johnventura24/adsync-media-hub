...
app.get('/api/test-tableau-integration', 
    ...
    async (req, res) => {
        try {
            ...
            if (tableauAutoExtractor) {
                console.log('📊 Testing Tableau auto extractor...');
                tableauData = await tableauAutoExtractor.getFreshData();
                console.log('✅ Tableau data extracted successfully');
            } else {
                console.error('❌ Tableau auto extractor not available');
            }
            ...
            res.json({
                ...
                results: {
                    tableauExtractorAvailable: !!tableauAutoExtractor,
