...
app.get('/admin', (req, res) => {
    console.log('Admin route accessed - redirecting to admin.html');
    res.redirect('/admin.html');
});

app.get('/admin.html', (req, res) => {
    const adminPath = path.join(__dirname, 'public', 'admin.html');
    console.log('Admin.html route accessed - looking for file at:', adminPath);
    ...
    if (fs.existsSync(adminPath)) {
        ...
        console.log('Admin.html not found, returning 404');
...
async function updateAdminCredentials() {
    try {
        ...
        // Fallback: Try to create admin user with basic SQL
        try {
            await dataService.query(`
                INSERT INTO users (username, email, password_hash, first_name, last_name, role, is_active) 
                VALUES ('ventura', 'ventura@adsyncmedia.com', '$2b$10$VM.C9r66VlGm5n2I19WdaeP.p4bW6pvFyFOEmrQZIXjw9D52DUDkm', 'Ventura', 'Admin', 'admin', TRUE)
            `);
            console.log('✅ Admin user created via fallback method');
        } catch (fallbackError) {
