...
// Update scorecard (Enhanced to show Tableau Public data)
function updateScorecard(scorecard) {
    ...
    console.log('✅ Scorecard updated with Tableau Public data');
}
...
async function loadNinetyScorecard() {
    try {
        ...
        if (Object.keys(scorecardData).length > 0) {
            showNotification('Loaded Scorecard data from Tableau Public', 'success');
        }
