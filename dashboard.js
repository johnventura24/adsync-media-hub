...
function updateGoogleAdsData(googleData) {
    ...
    impressionsElements.forEach(el => el.textContent = formatNumber(daily.impressions || 0));
    clicksElements.forEach(el => el.textContent = formatNumber(daily.clicks || 0));
    ctrElements.forEach(el => el.textContent = formatPercentage(daily.ctr || 0));
    revenueElements.forEach(el => el.textContent = formatCurrency(daily.revenue || 0));
    adSpendElements.forEach(el => el.textContent = formatCurrency(daily.adSpend || 0));
    profitElements.forEach(el => el.textContent = formatCurrency(daily.grossProfit || 0));
    ...
    roasElements.forEach(el => el.textContent = daily.roas || '0.00');
    cpcElements.forEach(el => el.textContent = formatCurrency(daily.cpc || 0));
    convRateElements.forEach(el => el.textContent = formatPercentage(daily.conversionRate || 0));
    ...
    statusElements.forEach(el => el.textContent = labels.performance || labels.status || 'Active');
    recommendationElements.forEach(el => el.textContent = labels.recommendation || 'Optimize campaigns');
