...
function populateDataTable() {
    ...
    const scorecardData = realData.scorecard || [];
    
    // If we have real scorecard data, use it; otherwise use sample data
    const dataToDisplay = scorecardData.length > 0 ? scorecardData : [
        {
